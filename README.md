...
Players level up skills to earn stat buffs, unlock and level up abilities, and more.
With an extensive configuration, the plugin is highly customizable, allowing you to tailor the experience to fit your server.
...
Players can design their own banners without complicated recipes needed. This is a unique way to symbolize their own claim/clan/group
-They can design and save
...
Pulsar Bow (temporarily summons a player-attracting block hole)
